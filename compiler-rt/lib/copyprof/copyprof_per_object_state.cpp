...
//===----------------------------------------------------------------------===//
///
/// This file implements per-object state tracking utilities for CopyProf,
/// managing transitive object sizes and allocation flags.
///
//===----------------------------------------------------------------------===//
