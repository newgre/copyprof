...
//===----------------------------------------------------------------------===//
///
/// This file declares the standard library interceptor interface for CopyProf,
/// defining hooks for intercepted memory and string functions.
///
//===----------------------------------------------------------------------===//
