...
//===----------------------------------------------------------------------===//
///
/// This file implements Linux-specific malloc and memory allocation interceptors
/// for CopyProf, wrapping application memory management calls.
///
//===----------------------------------------------------------------------===//
