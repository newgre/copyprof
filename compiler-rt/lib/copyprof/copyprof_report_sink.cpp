...
//===----------------------------------------------------------------------===//
///
/// This file implements the background reporting sink for CopyProf, managing
/// asynchronous flushing of buffered reports to configured backends.
///
//===----------------------------------------------------------------------===//
