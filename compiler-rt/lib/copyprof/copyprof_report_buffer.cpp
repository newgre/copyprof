...
//===----------------------------------------------------------------------===//
///
/// This file implements the lock-free report buffer for CopyProf, temporarily
/// storing profiling reports in memory before background flushing.
///
//===----------------------------------------------------------------------===//
