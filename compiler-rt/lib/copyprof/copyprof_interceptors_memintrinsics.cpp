...
//===----------------------------------------------------------------------===//
///
/// This file implements interceptors for memory intrinsic functions (memcpy,
/// memmove, memset) to correctly maintain shadow memory status.
///
//===----------------------------------------------------------------------===//
