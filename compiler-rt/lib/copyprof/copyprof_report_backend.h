...
//===----------------------------------------------------------------------===//
///
/// This file declares the abstract report backend interface for CopyProf,
/// enabling custom destinations for copy profiling reports.
///
//===----------------------------------------------------------------------===//
