...
//===----------------------------------------------------------------------===//
///
/// This file contains unit tests for the CopyProf background report sink,
/// testing asynchronous flushing and backend interactions.
///
//===----------------------------------------------------------------------===//
